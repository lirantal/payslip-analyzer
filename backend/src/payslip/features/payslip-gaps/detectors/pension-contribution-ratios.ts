import type { AnalysisResult, AnnotationSpec, PensionMoneyField } from '../../../types'
import {
  GAP_ANNOTATION_RED,
...
export function detectPensionContributionRatiosGap(analysis: AnalysisResult): {
  ...
  const employerShort = employerRatio < MIN_EMPLOYER_TAGMUL_RATIO - PENSION_RATIO_EPSILON
  const employeeShort = employeeRatio < MIN_EMPLOYEE_PENSION_RATIO - PENSION_RATIO_EPSILON
