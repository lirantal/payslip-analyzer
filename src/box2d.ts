 ...
 * @see https://cloud.google.com/vertex-ai/generative-ai/docs/bounding-box-detection
 */
...
/**
 * Converts a normalized box to pixel rectangle, clamping to 0–1000 and normalizing inverted corners.
 */
...
/** Expands a normalized box by `margin` (0–1000 scale) on each side, clamped to the image. */
